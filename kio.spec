...
Version  : 5.70.1
Release  : 35
URL      : https://download.kde.org/stable/frameworks/5.70/kio-5.70.1.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.70/kio-5.70.1.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.70/kio-5.70.1.tar.xz.sig
...
%prep
%setup -q -n kio-5.70.1
cd %{_builddir}/kio-5.70.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589846472
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kio-5.70.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kio/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kio5
